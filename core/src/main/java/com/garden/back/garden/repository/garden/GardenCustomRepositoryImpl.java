...
public class GardenCustomRepositoryImpl implements GardenCustomRepository {
    ...
    public GardensByComplexes getGardensByComplexes(
        ...
        return GardensByComplexes.of(gardenByComplexes, isHasNext(gardenByComplexes.size(), request.pageSize()));
    }
    ...
    private String makeScroll(GardenByComplexesRepositoryRequest request, String formattedQuery) {
