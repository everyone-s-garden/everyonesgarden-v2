...
public record GardenByComplexesResults(
    ...
    public static GardenByComplexesResults of(GardensByComplexes gardens) {
        ...
        return new GardenByComplexesResults(
            gardens.gardensByComplexes().stream()
                .map(gardenByComplexes -> GardenByComplexesResult.to(
                    gardenByComplexes,
                    gardenAndImages.get(gardenByComplexes.gardenId()
                    ))
    ...
    public record GardenByComplexesResult(
        ...
        public static GardenByComplexesResults.GardenByComplexesResult to
            (GardensByComplexes.GardenByComplexes garden, List<String> gardenImages) {
            return new GardenByComplexesResults.GardenByComplexesResult(
                garden.gardenId(),
                garden.size(),
                garden.gardenName(),
                garden.price(),
