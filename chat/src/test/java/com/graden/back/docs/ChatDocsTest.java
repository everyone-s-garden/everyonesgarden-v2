...
import com.graden.back.controller.ChatRoomController;
...
class ChatDocsTest extends RestDocsSupport {
    ...
    void createChatRoom() throws Exception {
        ChatRoomCreateRequest chatRoomCreateRequest = ChatRoomFixture.chatRoomCreateRequest();
        given(chatRoomService.createChatRoom(any())).willReturn(1L);
