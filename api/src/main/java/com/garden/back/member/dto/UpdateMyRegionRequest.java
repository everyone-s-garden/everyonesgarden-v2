...
import com.garden.back.member.region.UpdateMyRegionServiceRequest;
import jakarta.validation.constraints.DecimalMax;
import jakarta.validation.constraints.DecimalMin;
import jakarta.validation.constraints.NotEmpty;

public record UpdateMyRegionRequest(
    ...
    public UpdateMyRegionServiceRequest toServiceRequest(Long memberId) {
        return new UpdateMyRegionServiceRequest(Double.valueOf(latitude), Double.valueOf(longitude), memberId);
    }
}
