...
public record FindAllPostParamRequest(
    ...
    @EnumValue(enumClass = FindAllPostParamServiceRequest.OrderBy.class, message = "COMMENT_COUNT, RECENT_DATE, LIKE_COUNT, OLDER_DATE 중 한개를 입력해주세요")
    String orderBy

) {
    public FindAllPostParamServiceRequest toServiceDto() {
        return new FindAllPostParamServiceRequest(offset, limit, FindAllPostParamServiceRequest.OrderBy.valueOf(orderBy));
    }
