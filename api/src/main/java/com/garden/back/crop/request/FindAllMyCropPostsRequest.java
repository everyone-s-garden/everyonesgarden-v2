...
public record FindAllMyCropPostsRequest(
    ...
    public FindAllMyCropPostsRepositoryRequest toRepositoryDto() {
        return new FindAllMyCropPostsRepositoryRequest(offset, limit);
    }
}
